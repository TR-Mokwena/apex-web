    ...
    <>
      <div className="flex items-start justify-between gap-6 mb-4 flex-wrap">
        ...
        <div className="flex items-center gap-3 flex-wrap">
          ...
          <button className="flex items-center gap-1.5 h-[38px] px-3.5 rounded-[10px] text-white text-[13px] font-semibold shadow-[0_8px_18px_-8px_rgba(99,102,241,0.8)]" style={{ background: "linear-gradient(135deg,#6366F1,#8B5CF6)" }}><Icon name="Plus" size={15} />New Event</button>
        </div>
      </div>
